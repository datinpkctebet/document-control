...
@section('title', 'Daftar Dokumen Eksternal')
@section('page_title', 'Daftar Dokumen Eksternal')
...
$(document).ready(function() {
    ...
    $('#resetFilter').on('click', function() {
        window.location.href = '{{ route("dokumen.eksternal") }}';
    });
    ...
    $('#formUploadDokumen').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ route("dokumen.storeEksternal") }}',
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
    ...
    $('#formEditDokumen').on('submit', function(e) {
        ...
        $.ajax({
            url: '{{ url("dokumen/updateEksternal") }}/' + dokumenId,
            type: 'POST',
            data: formData,
            processData: false,
            contentType: false,
...
function openUploadModal(dokumenId) {
    ...
    $('#upload_id_dokumen_eksternal').val(dokumenId);
...
function editDokumen(dokumenId) {
    $.ajax({
        url: '{{ url("dokumen/get-dokumenEksternal") }}/' + dokumenId,
        type: 'GET',
        success: function(response) {
            if (response.success) {
...
function deleteDokumen(dokumenId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                url: '{{ url("dokumen/destroyEksternal") }}/' + dokumenId,
                type: 'DELETE',
                success: function(response) {
                    if (response.success) {
                        Swal.fire({
